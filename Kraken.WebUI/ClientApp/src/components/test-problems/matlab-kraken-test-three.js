...
export default class MatlabKrakenTestOne extends Component {
    ...
    acousticProblemData = {
        ...
        eta: 0,
        xi: 0,
        mediumInfo: '[9000,0,5000],[600,0.0,5300.000]',
...
[5300.000, 1613.108, 0.000, 1.75100, 0.000, 0.000]",
    ...
    render() {
        return (<Row>
            <Helmet>
                <title>Test case #3 (testkrak3.m)</title>
            </Helmet>
            <Col xs={12}>
                <div>
                    <p>Test case #3 (testkrak3.m) from <a href="https://oalib-acoustics.org/Modes/matlab.kraken.tgz">Matlab KRAKEN (B. Dushaw APL , Univ. of Washington )</a></p>
                </div>
