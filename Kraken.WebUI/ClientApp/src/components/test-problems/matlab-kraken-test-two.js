...
export default class MatlabKrakenTestTwo extends Component {
    ...
    acousticProblemData = {
        ...
        eta: 0,
        xi: 0,
        mediumInfo: '[1500,0,1000],[300,0.0,1300.000]',
...
[1000.00, 1467, 0.00, 1.7510, 0.00, 0.00],\
[1300.00, 1613, 0.00, 1.7510, 0.00, 0.00]",
        bottomBCType: 'R',
        sigma: 0,
        zb: 0,
        cpb: 0,
    ...
    render() {
        return (<Row>
            <Helmet>
                <title>Test case #2 (testkrak2.m)</title>
            </Helmet>
            <Col xs={12}>
                <div>
                    <p>Test case #2 (testkrak2.m) from <a href="https://oalib-acoustics.org/Modes/matlab.kraken.tgz">Matlab KRAKEN (B. Dushaw APL , Univ. of Washington )</a></p>
                </div>
